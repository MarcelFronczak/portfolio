    ...
    <nav className={theme}>
      <div className='nav-content'>
        ...
        <ul className={openMenu ? 'open' : ''}>
          <li><Link to="home" spy={true} smooth={true} offset={50} duration={500} onClick={() => setOpenMenu(false)}>HOME</Link></li>
          <li><Link to="" spy={true} smooth={true} offset={50} duration={500} onClick={() => setOpenMenu(false)}>SKILLS</Link></li>
          <li><Link to="" spy={true} smooth={true} offset={50} duration={500} onClick={() => setOpenMenu(false)}>PROJECTS</Link></li>
          <li><Link to="" spy={true} smooth={true} offset={50} duration={500} onClick={() => setOpenMenu(false)}>ABOUT</Link></li>
          <li><Link to="" spy={true} smooth={true} offset={50} duration={500} onClick={() => setOpenMenu(false)}>CONTACT</Link></li>
        </ul>
        <ul className='menu-web'>
          <li><Link to="home" spy={true} smooth={true} offset={50} duration={500}>HOME</Link></li>
          <li><Link to="" spy={true} smooth={true} offset={50} duration={500}>SKILLS</Link></li>
